...
CREATE TABLE [dbo].[tmp_ms_xx_Author] (
    ...
    [AusthorLastName] NVARCHAR (50) NOT NULL,
...
IF EXISTS (SELECT TOP 1 1 
           FROM   [dbo].[Author])
    BEGIN
        INSERT INTO [dbo].[tmp_ms_xx_Author] ([AuthorID], [AuthorFirstName], [AusthorLastName], [AuthorTFN])
        SELECT   [AuthorID],
                 [AuthorFirstName],
                 [AusthorLastName],
                 [AuthorTFN]
...
GO
ALTER TABLE [dbo].[Book] ALTER COLUMN [AuthorID] NVARCHAR (50) NOT NULL;
